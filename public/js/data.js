export function getUsers() {
  // getUsers:
  // - Obtiene usuarios desde localStorage ("users"). Siempre retorna un arreglo. Puede filtrar por email.
...
export function saveUsers(users) {
  // saveUsers:
  // - Guarda usuarios en localStorage ("users"). Puede reemplazar duplicados por email.
